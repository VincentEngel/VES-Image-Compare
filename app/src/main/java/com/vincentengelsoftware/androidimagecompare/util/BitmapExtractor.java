...
public class BitmapExtractor {
  ...
  /**
   * Decodes a {@link Bitmap} from a URI string. Supports both {@code file://} and content-provider
   * URIs.
   *
   * @param cr the {@link ContentResolver} used for content URIs
   * @param uriString a valid URI string
   * @return the decoded bitmap, or {@code null} if the string is invalid or decoding failed
   */
  @Nullable
