 ...
 * <p>
 * Callers obtain a new instance via {@link #of(BitmapTransformSettings)} after
 * writing the file, or reset to {@link #empty()} to force regeneration on the next check.
 * Use {@link #requiresRecalculation(File, BitmapTransformSettings)} to decide whether the
 * file is still valid.
 */
