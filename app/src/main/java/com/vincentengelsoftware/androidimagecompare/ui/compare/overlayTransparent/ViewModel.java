...
public class ViewModel extends androidx.lifecycle.ViewModel {
  ...
  /**
   * Whether zoom/pan state is synchronised between both image views. Initialised to {@code true};
   * updated from the Intent on first launch and from {@code savedInstanceState} on process-death
   * restoration.
   */
  private final AtomicBoolean sync = new AtomicBoolean(true);

  /** Returns the shared sync flag used by {@link com.vincentengelsoftware.androidimagecompare.ui.compare.shared.SyncZoom}. */
