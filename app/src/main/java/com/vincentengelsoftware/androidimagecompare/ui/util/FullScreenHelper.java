...
public final class FullScreenHelper {
  ...
  /**
   * Applies immersive full-screen flags to the given {@link Window} and keeps the screen on for the
   * lifetime of the window.
   *
   * <p>System bars are hidden and will reappear transiently on swipe.
   *
