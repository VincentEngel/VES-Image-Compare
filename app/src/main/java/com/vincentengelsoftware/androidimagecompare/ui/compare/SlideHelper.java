 ...
 *
 * <p>When clicked the button flips the {@code leftToRight} flag, updates its icon, and nudges the
 * seekbar so that {@code onProgressChanged} fires and triggers a fresh crop via the Activity's
 * seek-bar listener.
 */
public class SlideHelper {

  /**
   * Attaches a click listener to {@code directionButton} that toggles slide direction and resets
   * the seekbar to the midpoint.
   *
  ...
  public static void setSwapSlideDirectionOnClick(
      ImageButton directionButton, SeekBar seekBar, AtomicBoolean leftToRight) {
