...
public final class TapHelper {
    ...
    private TapHelper() { /* utility class */ }

    /**
     * Registers a click listener on {@code imageViewListener} that brings
     * {@code imageViewTarget} to the front (or makes it visible) and
     * optionally copies zoom/pan state when sync is active.
     *
