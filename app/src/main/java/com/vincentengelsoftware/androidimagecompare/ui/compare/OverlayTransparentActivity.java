...
/**
 * Displays two images stacked on top of each other and lets the user adjust
 * the opacity of the front image via a seekbar, or hide it entirely with a
 * toggle button.
 *
 * <p>The Activity owns only UI concerns: view binding, seekbar/button wiring, and
 * controls-bar animation. Bitmap retention and the sync-zoom flag are delegated
 * to {@link OverlayTransparentViewModel} so they survive configuration changes.</p>
 */
public class OverlayTransparentActivity extends AppCompatActivity implements ControlsBarHost {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        controlsBarManager = new ControlsBarManager(
                binding.overlayTransparentExtensions, getResources());
    ...
    private void initControls() {
        ...
        binding.overlayTransparentButtonHideFrontImage.setOnClickListener(view -> {
            ...
            } else if (binding.overlaySlideSeekBar.getProgress() <= TransparentHelper.HIDE_THRESHOLD) {
