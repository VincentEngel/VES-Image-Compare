...
public final class TransparentHelper {
   ...
   * inside this class and by the hide/show button logic in {@link OverlayTransparentActivity}.
   */
  public static final int HIDE_THRESHOLD = 2;

  private TransparentHelper() {
    /* utility class */
  }

  /**
   * Attaches a seekbar listener that controls the opacity of {@code imageView}. Hides the image
   * entirely when the progress drops to {@link #HIDE_THRESHOLD} or below.
   *
