...
public class OverlayTapViewModel extends ViewModel {
    ...
    /**
     * Whether zoom/pan state is copied to the other image view when the user taps
     * to switch images. Initialised to {@code true}; updated from the Intent on
     * first launch and from {@code savedInstanceState} on rotation.
     */
